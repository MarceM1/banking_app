...
export const getAccount = async ({ appwriteItemId }: getAccountProps) => {
  // console.log("iniciando getAccount");
  // console.log("appwriteItemId: ", appwriteItemId);

  try {
    // console.log("dentro del try de getAccount");
    // get bank from db
    ...
    // console.log('Dentro de getAccount:',{
...
export const getTransactions = async ({
  ...
  //console.log("iniciando getTransactions");
  let hasMore = true;
  let transactions: any = [];

  try {
    //console.log("dentro del try de getTransactions");
